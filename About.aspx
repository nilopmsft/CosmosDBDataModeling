<%@ Page Title="CosmosDB Data Modeling - About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="CosmosDataModelingv2.About" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="about_content">

        <h3>Data Modeling in Cosmos DB</h3>
            ...
            <pre>
    {
        ...
        <p>
            Looking at the results we can see a big improvement in cost that gets us basically the same movie search cost for
    ...
    that fit our use case. Given the situation of 1000 users performing these actions we are seeing an over <b>2.5x</b>
    ...
    so many methods of doing the same thing it was not worth presenting. Currently if a user searches on a single value
    in the Hybrid model, if all other browsing is done by clicking different presented results it is Point Read Queries.
